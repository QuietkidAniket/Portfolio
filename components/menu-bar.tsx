...
export default function MenuBar({ data }: MenuBarProps) {
  ...
  return (
    <div className="h-6 bg-black/20 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-4 text-white text-sm font-medium relative z-50">
